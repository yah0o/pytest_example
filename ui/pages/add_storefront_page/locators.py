...
class AddStorefrontLocators(object):
    ADD_STOREFRONT_HEADER = (By.ID, 'add_storefront_header')
    ...
    SAVE_BUTTON = (By.ID, 'add_storefront_save_button')
    CANCEL_BUTTON = (By.ID, 'add_storefront_cancel_button')
