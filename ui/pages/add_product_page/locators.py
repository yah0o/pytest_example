...
class AddProductLocators(object):
    ADD_PRODUCT_HEADER = (By.ID, 'add_product_header')
    ...
    PURCHASABLE_HEADER = (By.ID, 'purchasable_header')
    PURCHASABLE_TOGGLE = (By.ID, 'purchasable_toggle')
    PURCHASABLE_CHECKBOX = (By.ID, 'purchasable')
    NOT_PURCHASABLE_LABEL = (By.ID, 'purchasable_labelLeft')
    PURCHASABLE_LABEL = (By.ID, 'purchasable_labelRight')

    VISIBLE_HEADER = (By.ID, 'visible_header')
    VISIBLE_TOGGLE = (By.ID, 'visible_toggle')
    VISIBLE_CHECKBOX = (By.ID, 'visible')
    INVISIBLE_LABEL = (By.ID, 'visible_labelLeft')
    VISIBLE_LABEL = (By.ID, 'visible_labelRight')
    ...
    SAVE_BUTTON = (By.ID, 'add_product_save_button')
    CANCEL_BUTTON = (By.ID, 'add_product_cancel_button')
    ...
    def get_entity_list_locator_by_entity_type(entity_type):
        ...
        :rtype: (By, str)
        """
        return By.ID, "table_body_{}_table".format(entity_type)
    ...
    def get_entity_amount_input_locator_by_name(name):
        ...
        :rtype: (By, str)
        """
        return By.ID, "{}_amount".format(name)
    ...
    def get_entity_pct_value_input_locator_by_name(name):
        ...
        :rtype: (By, str)
        """
        return By.ID, "{}_percent".format(name)
